...
test.describe('Admin Dashboard', () => {
  ...
  test('navigating to Navigation section shows its content', async ({ page, isMobile }) => {
  ...
  test('navigating to Analytics section shows its content', async ({ page, isMobile }) => {
  ...
  test('navigating to Media section shows its content', async ({ page, isMobile }) => {
